%% Measure layout and scheduling runtimes for constellation 1.
clear;
clc;

demand_value = 3.0;              % Fixed demand: 3 Mbps
constellation_config_Mode = 1;   % Fixed constellation configuration: 1
...
fprintf('[START] figure18 | setups=%d | demand=%.2f | constellation=%d | usersPerCell=%d | RB=%d\n', ...
...
out_csv = '../../results/figure18_runtime.csv';
